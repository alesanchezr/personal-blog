...
function cleanblog_header() { ?>
	...
	<?php } else { ?>
	<?php $headerimg = get_template_directory_uri() . '/img/avila.gif'; ?>
	<?php } ?>
    <header class="intro-header" style="background-color: #404040; background-image: url('<?php echo $headerimg; ?>')">
        <div class="container">
			...
			<?php } else { ?>
                        <h1><?php esc_html_e( '{ Hello Wold }', 'cleanblog' ); ?></h1>
			<?php } ?>
                        <hr class="small">
			...
			<?php } else { ?>
                        <span class="subheading"><?php esc_html_e( 'Entrepreneurial and surviving thoughts from a passionate developer.', 'cleanblog' ); ?></span>
			<?php } ?>
                    </div>
		    <!-- /.site-heading -->
                </div>
