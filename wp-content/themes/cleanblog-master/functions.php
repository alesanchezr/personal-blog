...
function cleanblog_scripts() {
	...
	wp_enqueue_style( 'cleanblog-bootstrap', get_template_directory_uri() . '/css/bootstrap.css' );
	wp_enqueue_style( 'cleanblog-theme', get_template_directory_uri() . '/css/clean-blog.css' );
	...
	wp_enqueue_style( 'estandar-style', get_template_directory_uri() . '/css/estandar-style.css' );
    if ( is_page( 'resume' ) ) {
    ...
    if ( is_page( 'portfolio' ) ) {
        wp_enqueue_script('jquery.easing', get_template_directory_uri() . '/js/jquery.easing.min.js',array( ),$version,true );
        wp_enqueue_script('jquery.mixitup', get_template_directory_uri() . '/js/jquery.mixitup.min.js',array( ),$version,true );
        wp_enqueue_script('portfolio-js', get_template_directory_uri() . '/js/portfolio.js',array( ),$version,true );
    }
